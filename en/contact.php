...
<head>
    ...
    <title>Get infos - City Drive</title>
        ...
        <div class="container">
            <div class="collapse navbar-collapse"> <a href="index.php"><img src="assets/pic/title.png" class="navbar-brand"></a>
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="subscribe.php">Our subscriptions</a>
                    </li>
                </ul>
                <ul class="navbar-nav">
                    <?php
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <form method="POST" action="mail.php">
                    ...
                    <button name="mailform" type="submit" class="btn btn-secondary">Send !</button>
                </form>
            </div>
        </div>
    </div>
