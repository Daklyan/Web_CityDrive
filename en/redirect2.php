        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card text-primary">
                    <div class="card-header h1"> You're not logged in. </div>
                    <div class="card-body">
                        <p class="text-dark"> You can't reserve a drive without being connected, you'll be redirect to the home page. </p>
