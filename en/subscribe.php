                ...
                <table class="table text-center">
                    ...
                    <tr>
                        ...
                        <th class="text-center">
                            <h3> Demo account </h3>
                            <h2> <b>Free</b> </h2> <a class="btn btn-link text-primary" href="#">NULL</a>
                        </th>
                        <th class="text-center">
                            <h3> Simple </h3>
                    ...
                    <tr>
                        <td></td>
                        <td>Welcome one City Drive !</td>
                        <td>Join the community City Drive <br>and gets beneficial prices !</td>
                        <td>Join the community Business of City Drive <br>and become a institutional member !</td>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
